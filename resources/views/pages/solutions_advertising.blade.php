...
@section('content')
    ...
    @include('layouts.advertising_header')
        ...
        <div class="container-fluid">
            <div class="row client-robot">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 m-auto robot-do-for-clients">
                    Benefits that traditional <br>
                    <span style="color: #0a0dff">advertising</span> methods <br>
                    cannot match.
                </div>
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title" style="">ATTENTION-GRABBING</h4>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <p class="card-text "> Mobile robots can be programmed to interact
                                            with people, making advertising more engaging and memorable.
                                        </p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title">UNIQUE</h4>
                                        <p class="card-text ">Mobile robots offer a unique advertising platform that stands out from traditional methods, making the message more memorable.
                                        </p>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title">VERSATILE</h4>
                                        <p class="card-text ">Mobile robots can navigate different locations, reaching a wider audience in various environments such as malls, airports, and train stations.</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <p class="card-text"> Compared to other forms of advertising, mobile robots offer a cost-effective solution with a high return on investment due to their long service life and versatility.</p>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-block">
                                        <h4 class="card-title">DATA-DRIVEN</h4>
                                        <p class="card-text "> Mobile robots can collect valuable data such as customer behavior and preferences, which can be used to optimize future marketing strategies.</p>

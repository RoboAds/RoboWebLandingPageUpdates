        ...
        <div class="">
            ...
            <div id="intro" class="basic-1">
                <section class="feature-list section">
                    <div class="container-fluid featured-products">
                        ...
                        <div class="row alignment-for-mobile">
                            <div class="col-md-6 text-center">
                                ...
                                <img class="img-parallax" style="width: inherit"
                                     src="https://faceaqses.s3.amazonaws.com/roboads_website/jew_robot.png" alt="">
                            </div>
                            <div class="col-md-4 text-right-1" id="title_gulf">
                        ...
                        <div class="row">
                            <div class="col-md-6 left-text-1" id="coming_soon">
                                <div class="content mt-100">
                                    <img class="overlapped-image" src="{{asset('assets/images/files/overlapped.png')}}"
                                         alt="">
                                    <h4 class="subheading">AUDIENCE ATTENTION</h4>
                                    <p id="product-para">The autonomous RA-200 is programmed
                            ...
                            <div class="col-md-6">
                                <img class="img-responsive img-parallax" style="width: inherit"
                                     src="https://faceaqses.s3.amazonaws.com/roboads_website/workout-robot.png" alt="">
                            </div>
                        </div>
                        ...
                        <div class="row alignment-for-mobile">
                            <div class="col-md-6 text-center">
                                <div class="col position-absolute left-div"></div>
                                <img class="img-parallax" style="width: inherit"
                                     src="https://faceaqses.s3.amazonaws.com/roboads_website/telepresence-call.png"
                                     alt="">
                            </div>
                            <div class="col-md-4 text-right-2" id="title_gulf">
                                <div class="content mt-100">
                                    <img class="overlapped-image" src="{{asset('assets/images/files/overlapped.png')}}"
                                         alt="">
                                    <h4 class="subheading">TELEPRESENCE</h4>
                                    <p id="product-para">RA-200 Telepresence Robots help you
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-left-2" id="coming_soon">
                                <div class="content mt-100">
                                    <img class="overlapped-image " src="{{asset('assets/images/files/overlapped.png')}}"
                                         alt="">
                            ...
                            <div class="col-md-6 text-center">
                                ...
                                <img class="img-responsive img-parallax" style="width: inherit"
                                     src="https://faceaqses.s3.amazonaws.com/roboads_website/headset.png" alt="">
                            </div>
                        </div>
            ...
            <div id="callMe" class="form-1" style="background:transparent;padding-top: 4px;margin-bottom: -50px;margin-top: 40px;">
                <div class="container">
                    ...
                    <ul>
                        <li class="text-primary font-weight-bold"><a class="text-primary" target="_blank" style="text-decoration:none"
                                                                     href="https://roboedge.com"><i
                                    class='fa fa-leaf'></i> RoboEdge CMS Portal
                            </a></li>
                        <li class="text-primary font-weight-bold"><a class="text-primary" target="_blank" style="text-decoration:none"
                                                                     href="https://play.google.com/store/apps/details?id=com.aqses_telepresence.calls"><i
                                    class='fa fa-android'></i> Telepresence Application</a></li>
                        <li class="text-primary font-weight-bold"><i
                                class='fa fa-file-pdf-o'></i><button class="text-primary border-0 font-weight-bold" style="text-decoration:none;" onclick="getDownloadEn()"> Download Datasheet - RA-200.pdf (EN)</button></li>
                        <li class="text-primary font-weight-bold"><i
                                class='fa fa-file-pdf-o'></i><button onclick="getDownloadAr()" class="text-primary font-weight-bold border-0" style="text-decoration:none;"
                                                                     href="{{--{{route('getDownload')}}--}}"> Download Datasheet - RA-200.pdf (AR)</button></li>
                    </ul>
                </div>
            </div> <!-- end of form-1 -->
            <!-- end of call me -->
        ...
        function getDownloadEn(){
            $.ajax({
                ...
                success: function(response){
                    ...
                    link.download = "RA-200_Data_Sheet_EN.pdf";
                    link.click();
        ...
        function getDownloadAr(){
            $.ajax({
                ...
                success: function(response){
                    ...
                    var link = document.createElement('a');
                    link.href = window.URL.createObjectURL(blob);
                    link.download = "RA-200_Data_Sheet_AR.pdf";
                    link.click();

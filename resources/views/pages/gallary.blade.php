                    ...
                    <div class="grid">
                        ...
                        <div class="element-item youtube">
                            <a class="popup-with-move-anim" href="#project-1">
                                <div class="element-item-overlay"><span>AIBC <br> 2021</span></div>
                                <img src="{{asset('assets/images/aibc.jpg')}}" alt="alternative"></a>
                        </div>

                        <div class="element-item youtube">
                            <a class="popup-with-move-anim" href="#project-8">
                                <div class="element-item-overlay"><span>TELEPRESENCE</span></div>
                                <img src="{{asset('assets/images/Telepresence.jpg')}}" alt="alternative"></a>
                        </div>
                        <div class="element-item youtube ">
                            <a class="popup-with-move-anim" href="#project-3">
                                <div class="element-item-overlay"><span>GITEX <br> 2021</span></div>
                                <img src="{{asset('assets/images/gitex.jpg')}}" alt="alternative"></a>
                        </div>
                        <div class="element-item youtube">
                            <a class="popup-with-move-anim" href="#project-4">
                                <div class="element-item-overlay"><span>AIRSHOW <br> 2021</span></div>
                                <img src="{{asset('assets/images/airshow.jpg')}}" alt="alternative"></a>
                        </div>
                        <div class="element-item youtube">
                            <a class="popup-with-move-anim" href="#project-5">
                                <div class="element-item-overlay"><span>MEIDAM <br> 2021</span></div>
                                <img src="{{asset('assets/images/Meidam.jpg')}}" alt="alternative"></a>
                        </div>
                        <div class="element-item youtube">
                            <a class="popup-with-move-anim" href="#project-6">
                                <div class="element-item-overlay"><span>HUAWEI DUBAI <br> 2021</span></div>
                                <img src="{{asset('assets/images/Huawei.jpg')}}" alt="alternative"></a>
                        </div>
                        <div class="element-item youtube">
                            <a class="popup-with-move-anim" href="#project-7">
                                <div class="element-item-overlay"><span>DIGITAL SIGNAGE</span></div>
                                <img src="{{asset('assets/images/p7.JPG')}}" alt="alternative"></a>
                        </div>
                        <div class="element-item youtube">
                            <a class="popup-with-move-anim" href="#project-8">
                                <div class="element-item-overlay"><span>WAREHOUSE ROBOTICS</span></div>
                                <img src="{{asset('assets/images/p8.JPG')}}" alt="alternative"></a>
                        </div>
                    </div> <!-- end of grid -->
                    <!-- end of filter -->
                </div> <!-- end of col -->

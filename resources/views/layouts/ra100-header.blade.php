...
<header id="header" class="header">
    <div class="bg-video-wrap">
        <video class="my-video" src="https://faceaqses.s3.amazonaws.com/roboedge/ra_100_centre.mp4" autoplay loop muted >
        </video>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-container">
                                <h2 style="color: whitesmoke">RA-100</h2><br>
